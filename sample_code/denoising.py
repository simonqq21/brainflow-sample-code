...
def main():
    ...
    for count, channel in enumerate(eeg_channels):
        ...
        if count == 0:
            DataFilter.perform_rolling_filter(data[channel], 15, AggOperations.MEAN.value)
        elif count == 1:
            DataFilter.perform_rolling_filter(data[channel], 15, AggOperations.MEDIAN.value)
